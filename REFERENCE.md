...
**MLC extension (engineering review):** Partial crystallization produces intermediate resistance states — identical mechanism to MLC/TLC/QLC in flash storage. A single GST cell can store 2–4 bits via partial crystallization, independent of any wavelength tricks.
...
*(Calculation recorded during founding-session engineering review, 2026-03-23)*
